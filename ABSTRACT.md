...
This repository packages FSL alongside the governed bounded observer theorem stack. The observer theorem paper describes a model of agents as bounded observers: systems that act under limits of visibility, ambiguity, movement, cost, and commitment. The FSL language paper explains how those concepts are represented as governed symbols, canonical identifiers, type and family classifications, theorem aliases, display metadata, and publication exports.
