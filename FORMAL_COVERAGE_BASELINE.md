...
This document records the current formal coverage baseline for the public FSL observer theorem package after Mission 50.
...
| --- | ---: |
| Lean theorem checked | 31 |
| Lean theorem checked under axioms | 1 |
| Partial Lean theorem | 0 |
