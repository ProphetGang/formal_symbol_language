...
\midrule
Machine-checked theorem records & 30 \\
Machine-checked under explicit axioms & 1 \\
Partial machine-checked statements & 1 \\
...
\bottomrule
\end{tabular}
\caption{Formal coverage summary for public package v1.1.1.}
\label{tab:coverage}
\end{table}
...
\begin{quote}
\texttt{fsl-observer-theorem-v1.1.1}
\end{quote}
